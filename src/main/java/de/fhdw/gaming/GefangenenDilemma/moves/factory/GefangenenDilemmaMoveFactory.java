...
/**
 * Allows to create Demo moves.
 */
public interface GefangenenDilemmaMoveFactory {

    /**
     * Creates a move saying "yes".
     */
    GefangenenDilemmaMove createStaySilentMove();

    /**
     * Creates a move saying "no".
     */
    GefangenenDilemmaMove createSnitchMove();
