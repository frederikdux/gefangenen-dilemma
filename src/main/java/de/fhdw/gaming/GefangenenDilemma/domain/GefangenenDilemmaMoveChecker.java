...
/**
 * A Demo {@link MoveChecker} checking for supported Demo moves.
 */
public interface GefangenenDilemmaMoveChecker
        extends MoveChecker<GefangenenDilemmaPlayer, GefangenenDilemmaState, GefangenenDilemmaMove> {
}
