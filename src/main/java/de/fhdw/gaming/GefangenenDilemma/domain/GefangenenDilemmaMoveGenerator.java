...
/**
 * A Demo {@link MoveGenerator} generating valid Demo moves.
 */
public interface GefangenenDilemmaMoveGenerator
        extends MoveGenerator<GefangenenDilemmaPlayer, GefangenenDilemmaState, GefangenenDilemmaMove> {
}
