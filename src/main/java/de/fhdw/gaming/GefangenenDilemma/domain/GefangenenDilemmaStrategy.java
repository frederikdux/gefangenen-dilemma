...
/**
 * Represents a Demo strategy.
 */
public interface GefangenenDilemmaStrategy
        extends Strategy<GefangenenDilemmaPlayer, GefangenenDilemmaState, GefangenenDilemmaMove> {
