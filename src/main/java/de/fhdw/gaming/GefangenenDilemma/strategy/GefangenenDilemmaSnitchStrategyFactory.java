...
/**
 * Implements {@link GefangenenDilemmaStrategyFactory} by creating a {@link GefangenenDilemmaSnitchStrategy}.
 */
public final class GefangenenDilemmaSnitchStrategyFactory implements GefangenenDilemmaStrategyFactory {

    @Override
    public GefangenenDilemmaStrategy create(final GefangenenDilemmaMoveFactory moveFactory) {
        return new GefangenenDilemmaSnitchStrategy(moveFactory);
    }
}
